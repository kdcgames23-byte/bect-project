...
// === Servir le front-end depuis la racine ===
app.use(express.static(path.join(__dirname, "../"))); // "../" = dossier racine
app.get("/", (req, res) => res.sendFile(path.join(__dirname, "../index.html")));
app.get("/connexion.html", (req, res) => res.sendFile(path.join(__dirname, "../connexion.html")));
app.get("/inscription.html", (req, res) => res.sendFile(path.join(__dirname, "../inscription.html")));
app.get("/publier.html", (req, res) => res.sendFile(path.join(__dirname, "../publier.html")));
app.get("/admin.html", (req, res) => res.sendFile(path.join(__dirname, "../admin.html")));
app.get("/utilisateur.html", (req, res) => res.sendFile(path.join(__dirname, "../utilisateur.html")));
app.get("/niveau.html", (req, res) => res.sendFile(path.join(__dirname, "../niveau.html")));
